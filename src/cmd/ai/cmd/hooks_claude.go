...
//
// Every entry here MUST NOT appear in canonicalWiring. If a hook is purged
// and re-added by the canonical writer, settings.json never converges and
// the install path becomes non-idempotent — see the regression that surfaced
// after eaa65ca re-wired checkpoint-tick into Stop while it was still listed
// retired.
//
